...
Route::middleware(['auth', 'verified', 'enabled'])->group(function () {
    ...
    Route::middleware(['role:admin'])->group(function () {
        ...
        Route::get('/product/import', [ProductImportController::class, 'create'])->name('product.import.create');
        Route::post('/product/import', [ProductImportController::class, 'store'])->name('product.import.store');
        Route::get('/product/image', [ProductUploadImageController::class, 'create'])->name('product.image.create');
        Route::post('/product/image', [ProductUploadImageController::class, 'store'])->name('product.image.store');
