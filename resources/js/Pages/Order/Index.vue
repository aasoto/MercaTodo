                            ...
                            <tbody>
                                <tr v-for="order in orders.data" class="border-b border-gray-400">
                                    ...
                                    <td class="px-3 py-3 text-black dark:text-white capitalize flex justify-center items-center gap-3">
                                        ...
                                        <button v-else-if="order.payment_status == 'pending'" @click="generateNewURLWebcheckout(order.id)" class="bg-blue-600 rounded-md text-white px-3 py-1 flex justify-center items-center gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
