...
const actionAdd = () => {
    const found = find(props.product.id);
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-4">
                    ...
                    <div class="col-span-1 flex flex-col gap-4">
                        ...
                        <div v-if="role == 'client'" class="flex justify-center items-center gap-5">
                            ...
                            <button @click="actionAdd()" class="flex justify-center items-center gap-2 bg-red-500 hover:bg-red-600 scale-100 hover:scale-105 text-white px-5 py-3 rounded-md transition duration-200">
                                <span>
                                    Añadir al carrito
                                </span>
                            ...
                            <button v-if="find(product.id)" @click="remove(product.id)" class="rounded-md px-5 py-3 bg-gray-200 text-gray-800 scale-100 hover:scale-105 transition duration-200">
